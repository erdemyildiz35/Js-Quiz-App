...
let sorular = [
    new Soru("1-hangisi oop kavramlarından biridir?", { a: "node.js", b: "front-end", c: "kalıtım" , d: "sql" }, "c"),
    new Soru("2-hangisi bir database teknolojisidir ?", { a: "unity", b: "unreal engine ", c: "mongoDB" }, "c"),
